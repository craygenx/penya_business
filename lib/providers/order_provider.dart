...
final orderFilterProvider = StateProvider<OrderStatus>((ref) => OrderStatus.all);
final sortOrderProvider = StateProvider<SortOrder>((ref) => SortOrder.descending);
...
class OrderNotifier extends StateNotifier<List<OrdersModel>>{
  ...
  List<OrdersModel> getFilteredOrders(){
    ...
    if(orderStatus != OrderStatus.all){
      filteredOrders = filteredOrders.where((order)=> order.status == orderStatus.toString().split('.').last).toList();
    }
